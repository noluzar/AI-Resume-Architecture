...
export const MOCK_API_KEY = "mock-api-key-if-not-set"; // Fallback for process.env.API_KEY if not available in some environments. For actual use, process.env.API_KEY is primary.
