...
import { INITIAL_RESUME_DATA, DEFAULT_ACCENT_COLOR, TEMPLATE_OPTIONS, MOCK_API_KEY, INITIAL_PERSONAL_INFO, INITIAL_EXPERIENCE, INITIAL_EDUCATION, INITIAL_SKILL, INITIAL_CUSTOM_SECTION } from './constants';
...
if (API_KEY === MOCK_API_KEY) {
  console.warn("Using mock API key. Set process.env.API_KEY for actual Gemini API usage.");
}
